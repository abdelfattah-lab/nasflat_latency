...
nb201_latex = generate_latex_table('aggr_study_6_5_f_900/nb201_samp_eff.csv')
fbnet_latex = generate_latex_table('aggr_study_6_5_f_4k/fbnet_samp_eff.csv')

print("NB201 Table (more samples):\n", nb201_latex)
print("\nFBNet Table (more samples):\n", fbnet_latex)

nb201_latex = generate_latex_table('aggr_study_6_5_f/nb201_samp_eff.csv')
fbnet_latex = generate_latex_table('aggr_study_6_5_f_2/fbnet_samp_eff.csv')

print("NB201 Table:\n", nb201_latex)
print("\nFBNet Table:\n", fbnet_latex)

fbnet_latex = generate_latex_table('aggr_study_6_5_f_zcp/fbnet_samp_eff.csv')
