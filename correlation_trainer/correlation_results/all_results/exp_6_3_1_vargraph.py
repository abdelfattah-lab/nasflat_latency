...
def generate_graph_from_csv(file_path, space):
    ...
    for idx, task_ix in enumerate(task_indices):
        ...
        ax.text(0.5,0.90,'Device Set {}{}'.format("N" if space=='nb201' else "F", task_ix), fontsize=20,
    ...
    fig.legend(handles, labels, loc='upper center', bbox_to_anchor=(0.5, 1.12), ncol=len(allowed_metrics), fontsize=20)
