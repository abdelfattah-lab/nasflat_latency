...
latex_nb201 = generate_latex_table_from_csv('aggr_study_6_3_2_suppl/nb201_samp_eff.csv')
print(latex_nb201)

# For fbnet_samp_eff.csv
latex_fbnet = generate_latex_table_from_csv('aggr_study_6_3_2_suppl/fbnet_samp_eff.csv')
print(latex_fbnet)


# # For fbnet_samp_eff.csv
# latex_fbnet = generate_latex_table_from_csv('aggr_study_6_3_2_f0/fbnet_samp_eff.csv')
# print(latex_fbnet)
